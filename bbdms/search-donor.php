...
<?php $sql = "SELECT `BloodGroup` AS `bg` FROM `tblblooddonars` GROUP BY `BloodGroup`";
...
{               ?>  
<
<option value="<?php echo htmlentities($result->BloodGroup);?>"><?php echo htmlentities($result->bg);?></option>
<?php }} ?>
</select>
</div>
</div>
...
$sql = "SELECT * from tblblooddonars where BloodGroup=:bloodgroup";
$query = $dbh -> prepare($sql);
